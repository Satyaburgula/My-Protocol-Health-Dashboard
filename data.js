...
// ============================================================
const FOOD_DB = [
  // ---- PROTEINS ---- (cal/protein/carbs/fat/fiber cross-checked against USDA FoodData Central)
  { id: 'soya_chunks_dry',    name: 'Soya chunks (dry)',         unit: '100g',    cal: 345, protein: 52,   carbs: 33,  fat: 0.5, fiber: 13,  category: 'protein' },
  { id: 'soya_chunks_cooked', name: 'Soya chunks (cooked)',      unit: '100g',    cal: 112, protein: 17,   carbs: 9,   fat: 0.5, fiber: 4,   category: 'protein' },
  { id: 'tofu_firm',          name: 'Tofu, firm',                unit: '100g',    cal: 144, protein: 15.5, carbs: 2.8, fat: 8.7, fiber: 1.2, category: 'protein' },
  { id: 'paneer_lowfat',      name: 'Paneer, low-fat',           unit: '100g',    cal: 265, protein: 18,   carbs: 6,   fat: 20,  fiber: 0,   category: 'protein' },
  { id: 'paneer_fullfat',     name: 'Paneer, full-fat',          unit: '100g',    cal: 321, protein: 21,   carbs: 3.6, fat: 25,  fiber: 0,   category: 'protein' },
  { id: 'black_beans',        name: 'Black beans (cooked)',      unit: '100g',    cal: 132, protein: 8.9,  carbs: 24,  fat: 0.5, fiber: 8.7, category: 'protein' },
  { id: 'chickpeas',          name: 'Chickpeas / chole (cooked)',unit: '100g',    cal: 164, protein: 8.9,  carbs: 27,  fat: 2.6, fiber: 7.6, category: 'protein' },
  { id: 'rajma',              name: 'Rajma / kidney beans (cooked)',unit:'100g',  cal: 127, protein: 8.7,  carbs: 22.8,fat: 0.5, fiber: 6.4, category: 'protein' },
  { id: 'red_pinto_beans',    name: 'Pinto beans (cooked)',      unit: '100g',    cal: 143, protein: 9,    carbs: 26,  fat: 0.7, fiber: 9,   category: 'protein' },
  { id: 'green_peas',         name: 'Green peas',                unit: '100g',    cal: 84,  protein: 5.4,  carbs: 15.6,fat: 0.2, fiber: 5.5, category: 'protein' },
  { id: 'dal_generic',        name: 'Dal, generic (cooked)',     unit: '100g',    cal: 116, protein: 9,    carbs: 20,  fat: 0.4, fiber: 7.9, category: 'protein' },
  { id: 'dal_toor',           name: 'Toor dal (cooked)',         unit: '100g',    cal: 121, protein: 6.8,  carbs: 22.7,fat: 0.4, fiber: 6.7, category: 'protein' },
  { id: 'dal_moong',          name: 'Moong dal (cooked)',        unit: '100g',    cal: 105, protein: 7,    carbs: 19,  fat: 0.4, fiber: 7.6, category: 'protein' },
  { id: 'dal_masoor',         name: 'Masoor dal / red lentils (cooked)', unit:'100g', cal:116, protein:9,  carbs:20,   fat: 0.4, fiber: 7.9, category: 'protein' },
  { id: 'red_lentils_dry',    name: 'Red lentils (dry)',         unit: '100g',    cal: 352, protein: 24.6, carbs: 63,  fat: 1.1, fiber: 10.7,category: 'protein' },
  { id: 'whey_scoop',         name: 'Whey protein, 1 scoop',     unit: '1 scoop', cal: 120, protein: 24,   carbs: 4,   fat: 2,   fiber: 1,   category: 'protein' },
  { id: 'greek_yogurt',       name: 'Plain low-fat yogurt (Fage 0%)', unit:'100g',cal: 59, protein: 10,   carbs: 3.6, fat: 0,   fiber: 0,   category: 'protein' },
  { id: 'protein_bar',        name: 'No Cow / ALOHA protein bar',unit: '1 bar',   cal: 200, protein: 20,   carbs: 20,  fat: 7,   fiber: 19,  category: 'protein' },

  // ---- CARB STAPLES ----
  { id: 'rice_cooked',        name: 'Basmati / brown rice (cooked)', unit:'100g', cal: 130, protein: 2.7,  carbs: 28,  fat: 0.3, fiber: 1,   category: 'carb' },
  { id: 'quinoa_cooked',      name: 'Quinoa (cooked)',           unit: '100g',    cal: 120, protein: 4.4,  carbs: 21.3,fat: 1.9, fiber: 2.8, category: 'carb' },
  { id: 'oats_dry',           name: 'Rolled oats (dry)',         unit: '100g',    cal: 389, protein: 17,   carbs: 66,  fat: 6.9, fiber: 10.6,category: 'carb' },
  { id: 'roti',               name: 'Whole wheat roti',          unit: '1 piece', cal: 85,  protein: 3,    carbs: 18,  fat: 0.5, fiber: 2.5, category: 'carb' },
  { id: 'bread_daves',        name: "Dave's Killer Bread, 1 slice", unit:'1 slice',cal:110, protein: 5,    carbs: 22,  fat: 1.5, fiber: 3,   category: 'carb' },
  { id: 'tortilla_wheat',     name: 'Whole wheat tortilla',      unit: '1 piece', cal: 130, protein: 4,    carbs: 22,  fat: 3,   fiber: 3,   category: 'carb' },

  // ---- FATS ----
  { id: 'peanut_butter',      name: 'Natural peanut butter',     unit: '1 tbsp',  cal: 95,  protein: 4,    carbs: 3,   fat: 8,   fiber: 1,   category: 'fat' },
  { id: 'chia_seeds',         name: 'Chia seeds',                unit: '1 tbsp',  cal: 58,  protein: 2,    carbs: 5,   fat: 3.7, fiber: 4.1, category: 'fat' },
  { id: 'almonds',            name: 'Almonds, raw',              unit: '5 pieces',cal: 35,  protein: 1.3,  carbs: 1.3, fat: 3,   fiber: 0.7, category: 'fat' },
  { id: 'avocado',            name: 'Avocado',                   unit: '1/4 piece',cal:80,  protein: 1,    carbs: 4.3, fat: 7.4, fiber: 3.4, category: 'fat' },
  { id: 'tahini',             name: 'Tahini / lemon-cumin dressing', unit:'1 tbsp',cal:89, protein: 2.6,  carbs: 3.2, fat: 8,   fiber: 1.4, category: 'fat' },
  { id: 'olive_oil',          name: 'Olive oil',                 unit: '1 tsp',   cal: 40,  protein: 0,    carbs: 0,   fat: 4.5, fiber: 0,   category: 'fat' },

  // ---- OTHER / FRUITS / VEGETABLES ----
  { id: 'almond_milk',        name: 'Unsweetened almond milk',   unit: '100ml',   cal: 13,  protein: 0.4,  carbs: 0.4, fat: 1.1, fiber: 0.4, category: 'other' },
  { id: 'banana',             name: 'Banana, medium',            unit: '1 whole', cal: 105, protein: 1.3,  carbs: 27,  fat: 0.4, fiber: 3.1, category: 'other' },
  { id: 'apple',              name: 'Apple, medium',             unit: '1 whole', cal: 95,  protein: 0.5,  carbs: 25,  fat: 0.3, fiber: 4.4, category: 'other' },
  { id: 'orange',             name: 'Orange, medium',            unit: '1 whole', cal: 62,  protein: 1.2,  carbs: 15.4,fat: 0.2, fiber: 3.1, category: 'other' },
  { id: 'mango_berries_frozen',name:'Frozen mango / mixed berries',unit:'1/2 cup',cal:40,  protein: 0.6,  carbs: 9.5, fat: 0.2, fiber: 2.5, category: 'other' },
  { id: 'spinach',            name: 'Baby spinach / kale',       unit: '1 cup',   cal: 7,   protein: 0.9,  carbs: 1.1, fat: 0.1, fiber: 0.7, category: 'other' },
  { id: 'broccoli',           name: 'Broccoli, steamed',         unit: '100g',    cal: 35,  protein: 2.4,  carbs: 7.2, fat: 0.4, fiber: 3.3, category: 'other' },
  { id: 'cucumber',           name: 'Cucumber',                  unit: '100g',    cal: 15,  protein: 0.7,  carbs: 3.6, fat: 0.1, fiber: 0.5, category: 'other' },
  { id: 'tomato',             name: 'Tomato',                    unit: '100g',    cal: 18,  protein: 0.9,  carbs: 3.9, fat: 0.2, fiber: 1.2, category: 'other' },
  { id: 'salad_side',         name: 'Side salad (cucumber+tomato+onion)', unit:'1 bowl', cal:28, protein:1,carbs:5.8, fat:0.2, fiber: 1.5, category:'other' },
  { id: 'ryze_coffee',        name: 'RYZE mushroom coffee',      unit: '1 cup',   cal: 15,  protein: 0,    carbs: 3,   fat: 0,   fiber: 1,   category: 'other' }
];
